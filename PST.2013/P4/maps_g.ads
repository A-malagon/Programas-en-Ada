...
package Maps_G is
		...
		--Dada una tabla de simbolos y una clave asociada devuelve el valor.
		...
		--Mete dentro de la tabla de simbolos,insertar.
		...
		--Busca en funcion de la clave k reciba y elimina.
		...
		--Devuelve el número de vecinos que tiene cada uno.
	     function Map_Length (M : Map) return Natural;
		--Muestra por pantalla la tabla de simbolos.
